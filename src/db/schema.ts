import {
  ...
  export const fieldsTable = pgTable("fields", {
    ...
    sportId: uuid().notNull().references(() => sportsTable.id),  
    venueId: uuid().notNull().references(() => venuesTable.id),  
    createdAt: timestamp().notNull().defaultNow(),  
    updatedAt: timestamp().notNull().defaultNow()
  });
  ...
  export const bookingsTable = pgTable(
    "bookings",
    {
      ...
      fieldId: uuid().notNull().references(() => fieldsTable.id),  
  ...
  export const paymentsTable = pgTable("payments", {
    id: uuid().primaryKey().defaultRandom(),  
    bookingId: uuid().notNull().references(() => bookingsTable.id),  
